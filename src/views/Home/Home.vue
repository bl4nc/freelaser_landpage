...
export default {
  ...
  mounted() {
    ...
    swal.fire({
     ...
     <br>
     <a  href="https://api.whatsapp.com/send?l=pt&phone=5571999229912&text=Ol%C3%A1!%20Visitei%20o%20site%20da%20Freelaser%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." target="_blank" class="btn-orange btn mt-2">
